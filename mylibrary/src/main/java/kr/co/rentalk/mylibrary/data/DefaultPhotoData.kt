...
object DefaultPhotoData {
    ...
    val additional1 = PhotoData("가타 1", 16)
    val additional2 = PhotoData("가타 2", 17)
    val additional3 = PhotoData("가타 3", 18)
    val additional4 = PhotoData("가타 4", 19)
    val additional5 = PhotoData("가타 5", 20)
}